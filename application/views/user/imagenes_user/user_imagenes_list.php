    ...
    <div class="row-fluid">
        <div class="span9">
            <div class="row-fluid">
                ...
                <div class="span5">
                    <form action="<?php echo base_url() ?>user/imagenes_user/save/" method="post" enctype="multipart/form-data">
                ...
                <table class="table">
                    ...
                    <?php foreach ($datos_array as $var): ?>
                        <tr id="<?php echo "ah_" . $var['im_id_imagen'] ?>">
                            ...
                            <td>
                                <a href= "<?php echo base_url() . "user/imagenes_user/delete/" . $var['im_id_imagen'] . "/?im_id_imagen_tipo=" . $var['im_id_imagen_tipo'] ?>" ><i class="icon-remove"></i></a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </table>
