...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link href='http://fonts.googleapis.com/css?family=Chau+Philomene+One' rel='stylesheet' type='text/css'>
            ...
            <link rel="stylesheet" href="<?php echo base_url(); ?>css/light/light.css" type="text/css" media="screen" />
            <link rel="stylesheet" href="<?php echo base_url(); ?>css/dark/dark.css" type="text/css" media="screen" />
            <link rel="stylesheet" href="<?php echo base_url(); ?>css/bar/bar.css" type="text/css" media="screen" />
            <link rel="stylesheet" href="<?php echo base_url(); ?>css/nivo-slider.css">
                <link rel="stylesheet" href="<?php echo base_url(); ?>css/estilos.css">
                    ...
                    <!-- LIGHTBOX-->
                    <script type="text/javascript" src="<?php echo base_url(); ?>lightbox/js/jquery.lightbox-0.5.js"></script>
                    <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>lightbox/css/jquery.lightbox-0.5.css" media="screen" />
