...
class Imagenes_user extends CI_Controller
{
    ...
    function lists($im_id_imagen_tipo)
    {
        ...
        $data['view']              = "user/imagenes_user/user_imagenes_list";
        $data['js'] = array('js/user/imagenes_list','js/blockui-master/jquery.blockUI');
    ...
    function save()
    {
        ...
        redirect(base_url() . 'user/imagenes_user/lists/' . $im_id_imagen_tipo . "/", 'refresh');
    }
